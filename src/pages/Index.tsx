          ...
          <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="col-span-1 md:col-span-2">
                ...
                <p className="mt-4 text-gray-600 max-w-md">
                  Save time spent waiting in clinics with real-time doctor availability and queue updates.
                </p>
                <div className="flex space-x-6 mt-6">
                  {/* Social media icons can go here */}
                  <a href="#" className="text-gray-400 hover:text-fikar-primary transition-colors">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link to="/" className="text-base text-gray-600 hover:text-fikar-primary transition-colors">
                      Home
                    </Link>
                  </li>
                  <li>
                    <Link to="#features" className="text-base text-gray-600 hover:text-fikar-primary transition-colors">
                      Features
                    </Link>
                  </li>
                  <li>
                    <Link to="#how-it-works" className="text-base text-gray-600 hover:text-fikar-primary transition-colors">
                      How It Works
                    </Link>
                  </li>
                </ul>
              ...
              <div>
                <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase">Portals</h3>
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link to="/user-dashboard" className="text-base text-gray-600 hover:text-fikar-primary transition-colors">
                      Patient Portal
                    </Link>
                  </li>
                  <li>
                    <Link to="/doctor-dashboard" className="text-base text-gray-600 hover:text-fikar-primary transition-colors">
                      Doctor Portal
                    </Link>
                  </li>
                  <li>
                    <Link to="/admin-dashboard" className="text-base text-gray-600 hover:text-fikar-primary transition-colors">
                      Clinic Admin
                    </Link>
                  </li>
                </ul>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <p className="text-center text-gray-500">
                &copy; {new Date().getFullYear()} Fikar Plus. All rights reserved.
              </p>
            </div>
          </div>
        </footer>
